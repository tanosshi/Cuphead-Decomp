	...
	public class TextMeshPro : TMP_Text, ILayoutElement
	{
		...
		protected override int SetArraySizes(int[] chars)
		{
			...
			for (int n = num3; n < m_subTextObjects.Length + 1 && m_subTextObjects[n] != null; n++)
			{
				...
				{
					m_textInfo.meshInfo[n].ClearUnusedVertices(0, true);
				}
			}
		...
		protected override void GenerateTextMesh()
		{
			...
			for (int i = 0; m_char_buffer[i] != 0; i++)
			{
				...
				float num19 = m_currentFontAsset.fontInfo.Ascender * ((m_textElementType != TMP_TextElementType.Character) ? m_textInfo.characterInfo[m_characterCount].scale : num2) + m_baselineOffset;
				...
				float num20 = m_currentFontAsset.fontInfo.Descender * ((m_textElementType != TMP_TextElementType.Character) ? m_textInfo.characterInfo[m_characterCount].scale : num2) + m_baselineOffset;
